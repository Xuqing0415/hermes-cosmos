...
class CivilizationMigration:
    ...
    def export_state(
        self, include_knowledge: bool = True, include_tasks: bool = True, include_logs: bool = True
    ) -> Dict[str, Any]:
        state = {
            "version": "1.0",
    ...
    def _import_agents(self, agents_data: List[Dict[str, Any]]):
        from .types import AgentInfo, AgentRole
    ...
    def _import_knowledge(self, knowledge_data: List[Dict[str, Any]]):
        from .types import AgentRole, KnowledgeItem
    ...
    def _export_amendments(self) -> Dict[str, Any]:
        return {
            "total_amendments": (
                len(self.coordinator.amendment_system.amendments)
                if hasattr(self.coordinator, "amendment_system")
                else 0
            )
        }
    ...
    def _export_role_inventor(self) -> Dict[str, Any]:
        return {"total_role_definitions": 0, "total_failure_patterns": 0}
